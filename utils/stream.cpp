...
ssize_t stream::read(__attribute__((unused)) void *buf, __attribute__((unused)) size_t len)  {
...
bool stream::write(__attribute__((unused)) const void *buf, __attribute__((unused)) size_t len) {
...
off_t stream::seek(__attribute__((unused)) off_t off, __attribute__((unused)) int whence) {
...
bool filter_stream::write(const void *buf, size_t len, __attribute__((unused)) bool final) {
